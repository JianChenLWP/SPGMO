...
def Gra(x):
    # print("x",x)
    Gra_1 = np.zeros(2)
    Gra_1[0] = 0.125 / (x[0]**2 + x[1]**2) ** (0.875) * 2 * x[0]
    Gra_1[1] = 0.125 / (x[0]**2 + x[1]**2) ** (0.875) * 2 * x[1]
    Gra_2 = np.zeros(2)
    Gra_2[0] = 0.25 * ((x[0]-0.5)**2 + (x[1]-0.5)**2 ) ** (-0.75) * 2 * (x[0]-0.5)
    Gra_2[1] = 0.25 * ((x[0]-0.5)**2 + (x[1]-0.5)**2 ) ** (-0.75) * 2 * (x[1]-0.5)
